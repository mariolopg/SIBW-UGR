...
--
-- Host: mysql:3306
-- Generation Time: Jun 02, 2022 at 12:01 PM
...
INSERT INTO `sneakersInfo` (`id`, `name`, `description`, `precio`, `valoraciones`) VALUES
(1, 'Jordan X Dior', 'La Air Jordan 1 X Dior son unas de las colaboraciones más exclusivas dentro del mundo de la moda.', 7485, 150),
(2, 'Jordan Mid Lanen', 'La zapatilla Air Jordan 1 Mid está inspirada en la primera AJ1 y supone toda una oportunidad para los aficionados de las zapatillas Jordan clásicas de seguir los grandiosos pasos de su ídolo. El color vivo hace relucir los materiales elegantemente clásicos y aporta todo un toque innovador al conocido diseño.', 193, 58),
(3, 'Jordan Light Blue', 'Zapatillas Jordan 1 en color azul claro.', 120, 243),
(4, 'Jordan Tie Dye', 'Jordan 1 con estampado TieDye', 256, 12),
(5, 'Jordan X A Ma Maniére', 'La tienda de James Whitner en Atlanta A Ma Maniére es conocida por combinar el lujo de la alta costura con un gran sentido de la finalidad. En esta versión de las Air Jordan 1, la tienda se adentra en los mitos sobre MJ para crear un modelo a la altura de la leyenda.', 532, 24),
(6, 'Jordan Light Iron Ore', 'Las Air Jordan 1 Mid SE Light Iron Ore presentan una base de cuero blanco granulado con superposiciones de lona gruesa de color gris. Un swoosh de cuero rosa adorna los paneles y proporciona contraste a la silueta neutra. Las marcas de la firma, como el logotipo Jumpman y Wings, presentan un tono plateado que combina cuidadosamente con la entresuela blanca y la suela gris.', 125, 89),
(7, 'AF1 Classic', 'El fulgor sigue vivo con las Nike Air Force 1 \'07, un icono del baloncesto que aporta un nuevo toque a su ya característica piel impecable, sus colores llamativos y la cantidad perfecta de reflectante.', 100, 1329),
(8, 'AF1 University Blue', 'El clásico modelo AF1 con unos unos tonos azules.', 150, 512),
(9, 'AF1 Psychic Blue', 'El clásico modelo AF1 con unos unos tonos azules claros.', 150, 183),
(10, 'Dunk Low Essential Paisley', 'Dunk Low en tonos verdes.', 281, 238),
(11, 'Dunk Low StrangeLove', 'Dunk Low en tonos rojos', 678, 239),
(12, 'Dunk Low Green Glow', 'Dunk Low en tonos verde neón.', 248, 67);
...
(1, 'mariolopg', 'mario@gmail.com', '$2y$10$38tuxnFgFTzlBScsD6dxSOhdy7rTKBU8bw9PrzSRj05i/69C43VOO', 'superuser'),
(9, 'admin', 'admin@admin.com', '$2y$10$UwaE4cN/BYwK50BOI16jCOSzQD2wDfUhEK5vn8ZthXVH1qxZDfg72', 'superuser'),
(15, 'default', 'default@default.com', '$2y$10$3bSPEwVlcucc7SRfTamJju1qCvaozsZrdzAReLb9tVsIJDYQkbTHC', 'default'),
